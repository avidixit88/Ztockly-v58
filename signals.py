...
# ATR score normalization (AUTO) actually scales score
if pro_mode:
    score, cur_atr_pct, base_atr_pct, score_scale = _apply_atr_score_normalization(score, df, lookback=200, period=14)
    if cur_atr_pct is not None and base_atr_pct is not None:
        pro_diag["cur_atr_pct"] = cur_atr_pct
        pro_diag["base_atr_pct"] = base_atr_pct
        pro_diag["score_scale"] = score_scale
